-- Generated by build_whitelist.py -- FrameXML constants with their 3.3.5a values
return {
  ...
  QUEST_POI_COMPLETE_IN = 2,
  QUEST_POI_COMPLETE_OUT = 3,
  QUEST_POI_COMPLETE_SWAP = 4,
